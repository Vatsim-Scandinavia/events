...
export default function Edit({ event, calendars, bannerUrl }) {
    ...
    const handleEndDateChange = (date) => {
        setEndDate(date);
        if (date) setData('end_datetime', date.toISOString());
        else setData('end_datetime', '');
    };
                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="bg-white p-6" style={{ boxShadow: 'var(--shadow-card)' }}>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Banner Image (16:9)</label>
                                {previewUrl && (
                                    <div className="mb-3 border-2 border-grey-200 aspect-video bg-black flex items-center justify-center overflow-hidden">
                                ...
                                <input
                                    ...
                                    className="block w-full text-sm text-gray-700 file:mr-4 file:py-2 file:px-4 file:border-2 file:border-secondary file:bg-secondary file:text-white hover:file:bg-secondary-600"
                                />
                            ...
                            <div>
                                <label className="flex items-center mb-2 cursor-pointer">
                                    <input
                                        ...
                                        className="w-4 h-4 border-2 border-grey-300 text-secondary focus:ring-0"
                                    />
                                    <span className="ml-2 text-sm font-medium text-gray-700">Recurring Event</span>
                                </label>
                                            ...
                                            <div className="space-y-3">
                                                <label className="flex items-center gap-2">
                                                    <input
                                                        ...
                                                        className="w-4 h-4 text-secondary border-grey-300"
                                                    />
                            ...
                            <div className="flex justify-end space-x-3 pt-6 border-t-2 border-grey-100">
