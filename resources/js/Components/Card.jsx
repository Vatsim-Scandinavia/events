export default function Card({ title, subtitle, label, actions, children }) {
    return (
                ...
                <div className="flex justify-between items-center gap-4">
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            {label && <span className="px-2 py-0.5 text-[10px] font-bold tracking-wider bg-secondary text-white uppercase">{label}</span>}
                        </div>
