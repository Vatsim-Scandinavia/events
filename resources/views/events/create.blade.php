                            ...
                            <div class="row pt-2">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 mb-2">
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="radio" name="event_type" id="is_recurring" value="1" data-toggle="collapse" data-target="#recurringOptions" aria-expanded="false" aria-controls="recurringOptions">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 mb-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="event_type" id="is_full_day" value="2">
