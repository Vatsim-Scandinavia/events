...
@section('js')
    ...
    <script type="module">
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var defaultDate1 = "{{ old('start_date', isset($event) ? $event->start_date : '') }}";
            var defaultDate2 = "{{ old('end_date', isset($event) ? $event->end_date : '') }}";
            var defaultDate3 = "{{ old('recurrence_end_date', isset($event) ? $event->recurrence_end_date : '') }}";
            ...
            var isFullDayRadio = document.getElementById('standard_event');
