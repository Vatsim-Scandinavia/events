                            ...
                            <div class="row pt-2">
                                <div class="col-xs-12 col-sm-12 col-md-12 mb-2">
                                    <div class="form-group">
                                        <label for="event" class="form-label my-1 me-2">Event</label>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 mb-2">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description" rows="8" required>{{ old('description') }}</textarea>
                                        @error('description')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="section_1_title" class="form-label my-1 me-2">Section 1 Title</label>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 mb-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="1" id="restrict_booking">
                                        <label for="restrict_booking" class="form-label my-1 me-2">Restrict Booking</label>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12 mb-2">
                                    <div class="form-group">
                                        <label for="event" class="form-label my-1 me-2">FIR</label>
                                        <select name="event" id="event" class="form-control my-1 me-sm-2">
